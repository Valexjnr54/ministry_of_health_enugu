...
import { 
    add_facility_constant_price_list,
    add_facility_price_list,
    add_price_list,
    delete_facility_constant_price_list,
    delete_facility_price_list,
    delete_price_list, 
    update_facility_constant_price_list, 
    update_facility_price_list, 
    update_price_list, 
    view_facility_constant_price_lists, 
    view_facility_constant_single_price_list, 
...
adminPriceListRouter.post('/add-facility-constant-pricelist', authenticateJWT, add_facility_constant_price_list);
adminPriceListRouter.get('/view-facility-constant-pricelist', authenticateJWT, view_facility_constant_price_lists);
adminPriceListRouter.get('/view-single-facility-constant-pricelist', authenticateJWT, view_facility_constant_single_price_list);
adminPriceListRouter.put('/update-facility-constant-pricelist', authenticateJWT, update_facility_constant_price_list);
adminPriceListRouter.delete('/delete-facility-constant-pricelist', authenticateJWT, delete_facility_constant_price_list);