...
exports.sendApprovedFoodHandlerMail =
  exports.sendApprovedPersonnelMail =
  exports.sendRejectedInspectionMail =
  exports.sendApprovedInspectionMail =
  exports.sendAssignInspectionEmail =
  exports.sendResetSuccessEmail =
  exports.sendResetEmail =
  exports.sendFacilityPaymentEmail =
  exports.sendFoodPaymentEmail =
  exports.sendPaymentEmail =
  exports.sendFoodReceiptEmail =
  exports.sendPersonnelReceiptEmail =
  exports.sendVerificationEmail =
  exports.sendRenewalFacilityEmail =
  exports.sendRenewalFoodHandlerEmail =
  exports.sendRenewalEmail =
  exports.sendCreateSubAdminMail =
  exports.sendCreateEnforcerMail =
  exports.sendCreateInspectorMail =
  exports.sendWelcomeFoodMail =
  exports.sendWelcomeMail =
  exports.sendSaveAndExitMail =
  exports.sendCreateFacilityMail =
  exports.sendCompletionEmail =
  exports.sendReceiptEmail =
    void 0;
...
async function sendReceiptEmail(email, paymentDetails, fullname, reference) {
  ...
  const mailOptions = {
    ...
    html: ejs_1.default.render(template, {
      paymentDetails,
      email,
      fullname,
      reference,
...
async function sendRenewalEmail(
  ...
  const qrcode = await (0, generateQrcode_1.generateQRCode)(
    qrData,
  ...
  const certificate = await (0, generateQrcode_1.makeCopyAndModifyPDF)(
    originalFilePath,
    newFilePath,
    qrData,
    qrCodePath,
  ...
  const id_card = await (0, generateQrcode_1.makeIDCopyAndModifyPDF)(
    originalIDFilePath,
    newIDFilePath,
    qrData,
    qrCodePath,
  ...
  const upload = await (0, cloudinary_1.uploadFile)(
...
async function sendRenewalFoodHandlerEmail(
  email,
  paymentDetails,
  user,
  reference,
  ...
  // Read the EJS template from the file
  const template = fs_1.default.readFileSync(templatePath, "utf-8");
  const qrData = `https://enuguhealthverify.com/choose-verification?type=${type}&enugu_id=${enugu_practice_id}ice_id}`;
  const qrcode = await (0, generateQrcode_1.generateQRCode)(
    qrData,
    `public/static/qrcode.png`
  );
...
async function sendRenewalFacilityEmail(
  email,
  paymentDetails,
  user,
  reference,
  ...
  // Read the EJS template from the file
  const template = fs_1.default.readFileSync(templatePath, "utf-8");
  const qrData = `https://enuguhealthverify.com/verification?type=Facility&enugu_id=${enugu_facility_id}`;
  const qrcode = await (0, generateQrcode_1.generateQRCode)(
    qrData,
...
async function sendApprovedInspectionMail(
  email,
  facility,
  facility_name,
  enugu_facility_id,
...
async function sendRejectedInspectionMail(
  email,
  facility,
  facility_name,
  enugu_facility_id,
...
async function sendApprovedPersonnelMail(
  email,
  user,
  fullname,
  enugu_practice_id,
...
async function sendApprovedFoodHandlerMail(
  email,
  user,
  fullname,
  enugu_practice_id,
