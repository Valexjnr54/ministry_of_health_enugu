...
exports.facility_price_list_service = exports.personnel_price_list_service = void 0;
const models_1 = require("../models");
const prisma = new models_1.PrismaClient();
async function personnel_price_list_service(type) {
    try {
...
exports.personnel_price_list_service = personnel_price_list_service;
...
//     }
// }
async function facility_price_list_service(type, number_of_beds) {
    try {
        let price;
        if (number_of_beds) {
        ...
        const { application_fee, application_fee_charge, renewal_fee, renewal_charge, first_time_reg, first_time_charge, verification_charge, inspection_charge, certificate_charge, verification_fee, inspection_fee, certificate_fee } = price;
...
exports.facility_price_list_service = facility_price_list_service;
