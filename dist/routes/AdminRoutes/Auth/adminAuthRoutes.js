...
const adminAuthController_1 = require("../../../controllers/AdminController/Auth/adminAuthController");
...
exports.adminAuthRouter.get('/admin-profile', authenticationMiddleware_1.authenticateJWT, adminAuthController_1.profile);
